...
class _DetailLogbookMahasiswaState extends State<DetailLogbookMahasiswa> {
  LogbookPendaftarMonitoring? _logbook;
  ...
  Future<void> _fetchLogbook() async {
    try {
      final provider = Provider.of<LogbookPendaftarMonitoringProvider>(context,
          listen: false);
  ...
  Future<void> _fetchLogbookDokumen(String logbookPendaftarNomor) async {
    try {
      final provider =
          Provider.of<LogbookPendaftarDokumenProvider>(context, listen: false);
      await provider.fetchLogbookPendaftarDokumen(
          int.parse(widget.pendaftar.nomor), logbookPendaftarNomor);
      setState(() {
        _logbookDokumen =
